...
classdef baseStimulus < optickaCore & dynamicprops
	...
	%=======================================================================
		...
		function handles = makePanel(me, parent)
			...
			if ~isempty(me.handles) && isa(me.handles.root,'uix.Panel') && ishandle(me.handles.root)
			...
			handles.root = uix.Panel('Parent',parent,...
				'Title',me.fullName,...
				'FontName',SansFont,...
				'FontSize',fsmall,...
				'FontWeight','normal',...
		...
		function readPanel(me,varargin)
			if isempty(me.handles) || ~isa(me.handles.root,'uix.Panel')
				return
			end
