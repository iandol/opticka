...
% ========================================================================
	...
	properties (Access = protected)
		...
		ignorePropertiesBase = {'dp','animator','specialFlags','handles','ppd','sM',...
			...
			'doDrift','doFlash','doAnimator','mouseX','mouseY','szPx','szD','szIsPx',...
			'xFinalD','yFinalD','widthD','heightD'}
		%> Which properties to not draw in the UI panel
		ignorePropertiesUIBase = {'comment','animator','fullName','mvRect',...
			'xFinal','yFinal','szIsPx','szPx','szD','xFinalD','yFinalD'}
	end
