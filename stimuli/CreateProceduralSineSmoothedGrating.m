function [gratingid, gratingrect] = CreateProceduralSineSmoothedGrating(windowPtr, width, height, backgroundColorOffset, radius, contrastPreMultiplicator, sigma, useAlpha, method, shaderPath)
...
if isinf(radius)
    ...
    gratingShader = LoadGLSLProgramFromFiles({[shaderPath 'cosineaperture.vert.txt'], [shaderPath 'cosineaperture.frag.txt']}, 1);
end
