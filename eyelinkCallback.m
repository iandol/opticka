...
fprintf('--->>> EYELINKCALLBACK RUNNING\n');
...
switch eyecmd
    ...
    case 4,
        ...
        if verbose; fprintf('Eyelink image title is %s. [Threshold = %f]\n', msg, callArgs(2)); end
        if callArgs(2) ~= -1
    ...
    case 5,
        ...
        if verbose; fprintf('draw_cal_target.\n'); end
        calxy = callArgs(2:3);
        clearScreen=1;
        needsupdate = 1;
    ...
    case 6,
        ...
        if verbose; fprintf('clear_cal_display.\n'); end
        clearScreen=1;
        drawInstructions=1;
        needsupdate = 1;
    ...
    case 8,
        ...
        if verbose; fprintf('setup_image_display for %i x %i pixels.\n', eyewidth, eyeheight); end
        drawcount = 0;
        lastImageTime = GetSecs;
    ...
    case 10,
        ...
        if verbose; fprintf('erase_cal_target.\n'); end
        calxy = [];
        clearScreen=1;
        needsupdate = 1;
    case 11,
    ...
    case 15,
        ...
        errc = callArgs(2);
        if verbose; fprintf('dc_done_beep_hook: %i\n', errc); end
        if errc > 0
...
try
    ...
    if ~isempty(eyelinktex)
        ...
        if verbose; fprintf('EyelinkDrawCameraImage:DrawTexture \n'); end
