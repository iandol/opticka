...
pauseEntryFcn = { 
	...
	@()stopRecording(eL); ...
	@()trackerMessage(eL,'TRIAL_RESULT -10'); ...
...
prefixExitFcn = {
	...
	@()show(me.stimuli{2}); ...
	@()trackerMessage(eL,'V_RT MESSAGE END_FIX END_RT'); ...
	@()trackerMessage(eL,['TRIALID ' num2str(getTaskIndex(me))]); ...
...
incExitFcn = { 
	@()incorrect(io); ...
	@()trackerMessage(eL,'END_RT'); ...
	@()trackerMessage(eL,'TRIAL_RESULT 0'); ...
	@()stopRecording(eL); ...
	@()setOffline(eL); ... %set eyelink offline
