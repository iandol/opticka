...
stimExitFcn = {
	...
	@()doStrobe(me, true);
	% this adds stateMachine UUID to revcor stimulus frameLog
	@()addTag(stims{1}, sM.currentUUID); 
};
...
% checkTaskEnded = see if taskSequence has finished, if so set stopTask==true
