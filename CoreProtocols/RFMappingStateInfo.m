...
obj.stimuli.controlTable(n).stimuli = [2 3 4 5 6 7];
...
obj.stimuli.controlTable(n).stimuli = [1 2 3 4 5];
...
obj.stimuli.controlTable(n).delta = 0.5;
obj.stimuli.controlTable(n).stimuli = [8];
obj.stimuli.controlTable(n).limits = [0.5 20];
n=n+1;
...
obj.stimuli.stimulusSets = {[10], [2 10], [3 10], [4 10], [5 10], [6 10], [7 10], [8 10], [9 10]};
