% VEPTest protocol. DOESN'T use the eyetracker, runs a polar grating with
% different direction and contrast, present a fixation cross to guide the
% subject's eye's to be stable.

% fixed times for the state machine (see below)
fixTime = 0.5;
stimTime = 2;
ISITime = 1.9;
...
tS.name						= 'VEPTest';%==name of this protocol
...
%---------------------------------------------------------------------------------------------
'prefix'	'fixate'	ISITime	prefixEntryFcn	prefixFcn		{}				{};
'fixate'	'stimulus'	fixTime	fixEntryFcn		fixFcn			{}				fixExitFcn;
'stimulus'	'correct'	stimTime stimEntryFcn	stimFcn			{}				stimExitFcn;
