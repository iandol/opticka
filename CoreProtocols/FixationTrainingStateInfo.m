...
psEntryFcn = {
	...
	@()showSet(me.stimuli); % make sure we show the stimulus set
...
psExitFcn = { @()statusMessage(eL,'Stimulus...'); };
...
stimFcn = { 
	...
	@()drawEyePosition(eL); % draw the eye position to screen
	@()finishDrawing(s); % tell PTB we have finished drawing commands
