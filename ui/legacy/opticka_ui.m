...
% --- Executes on button press in OKInspectVariable.
function OKShuffleVariable_Callback(hObject, eventdata, handles)
if isappdata(handles.output,'o')
	o = getappdata(handles.output,'o');
	v = get(handles.OKVarList,'Value');
	if v > 0
...
elseif ispc
	...
	if system('fc-list -q "Source Sans" family')
		nfont = 'Source Sans 3';
	else
...
tab1 = uitab(tabgp,'Title','Display','ForegroundColor',[0.5 0.3 0.3],'Tag','OKtab1','Tooltip','Change Display and main settings...');
tab2 = uitab(tabgp,'Title','Task','ForegroundColor',[0.5 0.3 0.3],'Tag','OKtab2','Tooltip','View/Change Behavioural Task settings...');
tab3 = uitab(tabgp,'Title','Options','ForegroundColor',[0.5 0.3 0.3],'Tag','OKtab3','Tooltip','Load protocols, edit additional settings...');
...
'FontUnits','pixels',...
'Units','normalized',...
'String',{'Patch Tuning'; 'Plaid'; 'Reverse Correlation' },...
'Style','listbox',...
'Value',1,...
...
'Units','normalized',...
'String','#',...
'Position',[0.88 0.93 0.05 0.08],...
'Callback',@(hObject,eventdata)opticka_ui('OKShuffleVariable_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'Enable','on',...
'Tag','OKShuffleVariable',...
'FontSize',ssize,...
'FontName',nfont);
