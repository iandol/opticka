...
'String','400 400',...
'Style','edit',...
'Position',[0.58 0.762820512820513 0.074 0.13],...
'BackgroundColor',[1 1 1],...
...
'String','100',...
'Style','edit',...
'Position',[0.58 0.442307692307692 0.074 0.13],...
'BackgroundColor',[1 1 1],...
...
'Style','checkbox',...
'Position',[0.58 0.602564102564103 0.110803324099723 0.13],...
'BackgroundColor',bcolour,...
...
'Style','text',...
'Position',[0.655 0.775 0.06 0.13],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text182',...
'UserData',[],...
...
'FontUnits','pixels',...
'Units','normalized',...
'String','Display++ Strobe Mode',...
'Style','text',...
'Position',[0.9 0.4 0.1 0.13],...
'BackgroundColor',bcolour,...
'HorizontalAlignment','left',...
'Children',[],...
'FontSize',10,...
...
'Style','text',...
'Position',[0.475485661424607 0.910398717691845 0.093 0.0774193548387097],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text8',...
'FontSize',10,...
...
'Callback',@(hObject,eventdata)opticka_ui('OKHideFlash_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'TooltipString','Draw simple fixation cross',...
'Tag','OKDrawFixation',...
'FontSize',10,...
'FontName',nfont);
...
'String','Record Movie',...
'Style','checkbox',...
'Position',[0.48 0.347826086956522 0.1 0.1],...
'BackgroundColor',bcolour,...
...
'Style','edit',...
'Position',[0.370027752081406 0.87 0.095 0.129032258064516],...
'BackgroundColor',[1 1 1],...
