...
'String','0',...
'Style','edit',...
'Position',[0.003 0.0621 0.1 0.13],...
'BackgroundColor',[1 1 1],...
...
'Style','popupmenu',...
'Value',2,...
'Position',[0.176 0.869565217391304 0.11 0.13],...
'BackgroundColor',[1 1 1],...
...
'Style','popupmenu',...
'Value',1,...
'Position',[0.176 0.708074534161491 0.11 0.13],...
'BackgroundColor',[1 1 1],...
...
'String','0',...
'Style','edit',...
'Position',[0.176 0.22360248447205 0.11 0.13],...
'BackgroundColor',[1 1 1],...
...
'Style','popupmenu',...
'Value',1,...
'Position',[0.176 0.385093167701863 0.11 0.13],...
'BackgroundColor',[1 1 1],...
...
'Style','checkbox',...
'Value',1,...
'Position',[0.48 0.739130434782609 0.080 0.1],...
'BackgroundColor',bcolour,...
...
'String', {'FloatingPoint32BitIfPossible'; 'FloatingPoint32Bit';...
	'FixedPoint16Bit'; 'FloatingPoint16Bit'; '8bit'; ...
	'EnableBits++Bits++Output'; 'EnableBits++Mono++Output'; ...
	'EnableBits++Color++Output'; 'EnableBits++Mono++OutputWithOverlay'; ...
	'EnablePseudoGrayOutput'; 'EnableNative10BitFramebuffer';...
	'EnableNative10BitFramebuffer'; 'EnableNative16BitFramebuffer'; ...
	'EnableNative16BitFloatingPointFramebuffer' },...
'Style','popupmenu',...
'Value',1,...
