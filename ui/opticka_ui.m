...
'FontUnits','pixels',...
'Units','normalized',...
'String',{  'xPosition'; 'yPosition'; 'angle'; 'colour'; 'direction'; 'size'; 'sf'; 'tf'; 'contrast'; 'alpha'; 'speed'; 'phase'; 'startPosition'; 'barLength'; 'barWidth'; 'alpha'; 'nDots'; 'coherence'; 'scale'; 'driftDirection' },...
'Style','listbox',...
'Value',1,...
