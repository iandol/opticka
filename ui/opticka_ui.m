...
'FontUnits','pixels',...
'Units','normalized',...
'SelectedObjectMode','manual',...
'SerializableSelectedObjectMode','manual',...
...
tabgp = uitabgroup(h1,'Position',[0 0.72 1 0.28],'TabLocation','left','Tag','OKtabgp');
...
'Label','Run Randomised Experiment',...
'Tag','OKRunExperiment',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'String','Omniplex?',...
'Style','checkbox',...
'Position',[0.737044731712319 0.796052631578947 0.0680000000000001 0.131578947368421],...
'BackgroundColor',[0.9 0.9 0.9],...
...
'String','IP',...
'Style','text',...
'Position',[0.912031907253514 0.835188933873144 0.0101851851851852 0.0789473684210527],...
'BackgroundColor',[0.9 0.9 0.9],...
'Children',[],...
'Tag','text208',...
'FontSize',9,...
...
'Style','edit',...
'Position',[0.807940904893813 0.634615384615385 0.101569713758079 0.134615384615385],...
'BackgroundColor',[1 1 1],...
'Children',[],...
'Tag','OKeyeOccluder',...
'FontSize',9,...
...
'String','File Name:',...
'Style','text',...
'Position',[0.00462534690101758 0.95 0.875115633672525 0.0875],...
'BackgroundColor',[0.9 0.9 0.9],...
'Children',[],...
...
'Children',[],...
'TooltipString','Use the OS native beam position queries or override with PTB routine; override is better for OS X allong with use of the kernel driver',...
...
'SerializableSelectedObjectMode','manual',...
'ForegroundColor',[0.313725490196078 0.313725490196078 0.313725490196078],...
'Title','Methods of Constants (MOC) Only Settings',...
...
'Children',[],...
'TooltipString','Trial time for acute run (not using state machine)',...
'ParentMode','manual',...
'Tag','OKtrialTime',...
'FontSize',11,...
'FontName','Menlo',...
...
'Title','Stimulus List',...
'Position',[0 0.521739130434783 0.2895467160037 0.49],...
'BackgroundColor',[0.9 0.9 0.9],...
'Clipping','off',...
'ChildrenMode','manual',...
...
'Units','normalized',...
'String','?',...
'Position',[0.941747572815534 0.924 0.05 0.0940000000000002],...
'BackgroundColor',get(0,'defaultuicontrolBackgroundColor'),...
'BackgroundColorMode',get(0,'defaultuicontrolBackgroundColorMode'),...
...
'Position',[0.883495145631068 0.924 0.05 0.0940000000000002],...
'BackgroundColor',get(0,'defaultuicontrolBackgroundColor'),...
'BackgroundColorMode',get(0,'defaultuicontrolBackgroundColorMode'),...
...
'Position',[0.825242718446602 0.924 0.05 0.0940000000000002],...
'BackgroundColor',get(0,'defaultuicontrolBackgroundColor'),...
'BackgroundColorMode',get(0,'defaultuicontrolBackgroundColorMode'),...
...
'Units','normalized',...
'String','R',...
'Position',[0.766990291262136 0.924 0.05 0.0940000000000002],...
'BackgroundColor',get(0,'defaultuicontrolBackgroundColor'),...
'BackgroundColorMode',get(0,'defaultuicontrolBackgroundColorMode'),...
...
'Units','normalized',...
'String','BR',...
'Position',[0.70873786407767 0.924 0.05 0.0940000000000002],...
'BackgroundColor',get(0,'defaultuicontrolBackgroundColor'),...
'BackgroundColorMode',get(0,'defaultuicontrolBackgroundColorMode'),...
...
'Units','normalized',...
'String','A',...
'Position',[0.650485436893204 0.924 0.05 0.0940000000000002],...
'BackgroundColor',get(0,'defaultuicontrolBackgroundColor'),...
'BackgroundColorMode',get(0,'defaultuicontrolBackgroundColorMode'),...
...
'Units','normalized',...
'String','BA',...
'Position',[0.592233009708739 0.924 0.05 0.0940000000000002],...
'BackgroundColor',get(0,'defaultuicontrolBackgroundColor'),...
'BackgroundColorMode',get(0,'defaultuicontrolBackgroundColorMode'),...
...
'Units','normalized',...
'String','RS',...
'Position',[0.533980582524272 0.924 0.05 0.0940000000000002],...
'BackgroundColor',get(0,'defaultuicontrolBackgroundColor'),...
'BackgroundColorMode',get(0,'defaultuicontrolBackgroundColorMode'),...
...
'Position',[0.296022201665125 0.0434782608695652 0.701202590194265 0.471395881006865],...
'BackgroundColor',[0.9 0.9 0.9],...
'Clipping','off',...
'ChildrenMode','manual',...
...
'ForegroundColor',[0.313725490196078 0.313725490196078 0.313725490196078],...
'ShadowColor',[0.501960784313725 0.501960784313725 0.501960784313725],...
'Title','Ind. Variable List',...
'Position',[0 0.0434782608695652 0.29 0.471395881006865],...
'BackgroundColor',[0.9 0.9 0.9],...
'Clipping','off',...
'ChildrenMode','manual',...
'Tag','uipanel44',...
...
'Units','normalized',...
'String','?',...
'Position',[0.940413877054169 0.935224235224235 0.0471698113207547 0.081081081081081],...
'BackgroundColor',get(0,'defaultuicontrolBackgroundColor'),...
'BackgroundColorMode',get(0,'defaultuicontrolBackgroundColorMode'),...
...
'TitlePosition','centertop',...
'Title',blanks(0),...
'Position',[0.296022201665125 0.528604118993135 0.700277520814061 0.469107551487414],...
'BackgroundColor',[0.9 0.9 0.9],...
'Clipping','off',...
'Tag','OKPanelStimulus',...
...
'Style','text',...
'Position',[0.380449141347424 0.472906403940887 0.219286657859974 0.0886699507389163],...
'BackgroundColor',[0.9 0.9 0.9],...
'Children',[],...
'ForegroundColor',[0.494117647058824 0.494117647058824 0.494117647058824],...
'Enable','off',...
