...
tab3 = uitab(tabgp,'Title','Protocol','Tag','OKtab3');
...
'FontUnits','pixels',...
'Units','normalized',...
'String','Display++ Strobe',...
'Style','text',...
'Position',[0.9 0.4 0.1 0.14],...
'BackgroundColor',bcolour,...
'HorizontalAlignment','left',...
'Children',[],...
'FontSize',10,...
...
'Style','edit',...
'Value',10,...
'Position',[0.003 0.0451612903225806 0.874190564292322 0.870967741935484],...
...
'String','Gamma',...
'Style','text',...
'Position',[0.29 0.415626309174696 0.08 0.0974025974025974],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text189',...
'FontSize',10,...
...
'String','Window',...
'Style','text',...
'Position',[0.11 0.415626309174696 0.06 0.0974025974025974],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text83',...
'FontSize',10,...
...
'String','Src Blend',...
'Style','text',...
'Position',[0.29 0.896774193548387 0.08 0.0967741935483871],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text100',...
'FontSize',10,...
...
'String','Dst blend',...
'Style','text',...
'Position',[0.29 0.740301633850021 0.08 0.0974025974025974],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text101',...
'FontSize',10,...
...
'String','X Center',...
'Style','text',...
'Position',[0.11 0.247077466712811 0.06 0.0974025974025974],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text6',...
'FontSize',10,...
...
'String','Y Center',...
'Style','text',...
'Position',[0.11 0.0785286242509244 0.06 0.0974025974025974],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text7',...
'FontSize',10,...
...
'String','Monitor',...
'Style','text',...
'Position',[0.11 0.896187683284458 0.06 0.0974025974025974],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text3',...
'FontSize',10,...
...
'String','Bit Depth',...
'Style','text',...
'Position',[0.29 0.577963971512359 0.0833333333333334 0.0974025974025974],...
'BackgroundColor',bcolour,...
'Children',[],...
...
'String','Distance(cm)',...
'Style','text',...
'Position',[0.11 0.740301633850021 0.06 0.0974025974025974],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text4',...
'FontSize',10,...
...
'String','Px / cm',...
'Style','text',...
'Position',[0.11 0.577963971512359 0.06 0.0974025974025974],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text5',...
'FontSize',10,...
...
'Style','text',...
'Position',[0.29 0.247077466712811 0.08 0.0974025974025974],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text102',...
'FontSize',10,...
...
'String','57.3',...
'Style','edit',...
'Position',[0.003 0.708074534161491 0.1 0.13],...
'BackgroundColor',[1 1 1],...
...
'String','32',...
'Style','edit',...
'Position',[0.003 0.546583850931677 0.1 0.13],...
'BackgroundColor',[1 1 1],...
...
'String','[]',...
'Style','edit',...
'Position',[0.003 0.385093167701863 0.1 0.13],...
'BackgroundColor',[1 1 1],...
...
'String','0',...
'Style','edit',...
'Position',[0.003 0.22360248447205 0.1 0.13],...
'BackgroundColor',[1 1 1],...
...
'String','0',...
'Style','edit',...
'Position',[0.003 0.062111801242236 0.1 0.13],...
'BackgroundColor',[1 1 1],...
...
'String','GL Blending',...
'Style','checkbox',...
'Position',[0.369 0.739130434782609 0.1 0.1],...
'BackgroundColor',bcolour,...
...
'Style','popupmenu',...
'Value',1,...
'Position',[0.003 0.869565217391304 0.1 0.13],...
'BackgroundColor',[1 1 1],...
...
'Style','popupmenu',...
'Value',2,...
'Position',[0.175763182238668 0.869565217391304 0.11 0.13],...
'BackgroundColor',[1 1 1],...
...
'Style','popupmenu',...
'Value',1,...
'Position',[0.175763182238668 0.708074534161491 0.11 0.13],...
'BackgroundColor',[1 1 1],...
...
'String','0',...
'Style','edit',...
'Position',[0.175763182238668 0.22360248447205 0.11 0.13],...
'BackgroundColor',[1 1 1],...
...
'Style','checkbox',...
'Position',[0.48 0.217391304347826 0.1 0.1],...
'BackgroundColor',bcolour,...
...
'Style','popupmenu',...
'Value',1,...
'Position',[0.175763182238668 0.385093167701863 0.11 0.13],...
'BackgroundColor',[1 1 1],...
...
'Style','checkbox',...
'Value',1,...
'Position',[0.48 0.739130434782609 0.0795559666975024 0.1],...
'BackgroundColor',bcolour,...
...
'FontUnits','pixels',...
'Units','normalized',...
'String', {'FloatingPoint32BitIfPossible'; 'FloatingPoint32Bit'; 'FixedPoint16Bit'; 'FloatingPoint16Bit'; '8bit'; 'EnableBits++Bits++Output'; 'EnableBits++Mono++Output'; 'EnableBits++Color++Output'; 'EnableBits++Mono++OutputWithOverlay'; 'EnablePseudoGrayOutput'; 'EnableNative10BitFramebuffer' },...
'Style','popupmenu',...
'Value',1,...
'Position',[0.175763182238668 0.546583850931677 0.11 0.13],...
'BackgroundColor',[1 1 1],...
...
'String','4',...
'Style','edit',...
'Position',[0.175763182238668 0.062111801242236 0.11 0.13],...
'BackgroundColor',[1 1 1],...
...
'String','Benchmark',...
'Style','checkbox',...
'Position',[0.48 0.608695652173913 0.0795559666975024 0.1],...
'BackgroundColor',bcolour,...
...
'Style','text',...
'Position',[0.29 0.0850221307444309 0.08 0.0974025974025974],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text203',...
'FontSize',10,...
...
'Style','checkbox',...
'Value',1,...
'Position',[0.023 0.27007299270073 0.265446224256293 0.14],...
'BackgroundColor',bcolour,...
...
'Style','popupmenu',...
'Value',1,...
'Position',[0.023 0.452554744525547 0.25 0.14],...
'BackgroundColor',[1 1 1],...
...
'String','Random Type',...
'Style','text',...
'Position',[0.28 0.496598639455782 0.203196347031963 0.1],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text105',...
'FontSize',10,...
...
'String','[]',...
'Style','edit',...
'Position',[0.023 0.635036496350365 0.25 0.14],...
'BackgroundColor',[1 1 1],...
...
'String','Random Seed',...
'Style','text',...
'Position',[0.28 0.687074829931973 0.17 0.1],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text106',...
'FontSize',10,...
...
'String','5',...
'Style','edit',...
'Position',[0.023 0.832116788321168 0.25 0.14],...
'BackgroundColor',[1 1 1],...
...
'Style','text',...
'Position',[0.75 0.883561643835616 0.247139588100686 0.09],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text107',...
'FontSize',10,...
...
'Style','checkbox',...
'Value',1,...
'Position',[0.023 0.10948905109489 0.24 0.14],...
'BackgroundColor',bcolour,...
...
'Style','text',...
'Position',[0.4 0.43 0.0989445910290238 0.0810810810810811],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text140',...
'UserData',[],...
...
'Style','text',...
'Position',[0.4 0.56 0.0989445910290238 0.081081081081081],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text141',...
'UserData',[],...
...
'Style','text',...
'Position',[0.4 0.726792356363971 0.0989445910290238 0.0810810810810811],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text142',...
'UserData',[],...
...
'Style','text',...
'Position',[0.4 0.286737252716634 0.112137203166227 0.0810810810810811],...
'BackgroundColor',bcolour,...
'Children',[],...
'Tag','text178',...
'UserData',[],...
...
'FontUnits','pixels',...
'Units','normalized',...
'String',{  'xPosition'; 'yPosition'; 'angle'; 'colour'; 'motionAngle'; 'size'; 'sf'; 'tf'; 'contrast'; 'alpha'; 'speed'; 'phase'; 'startPosition'; 'barLength'; 'barWidth'; 'alpha'; 'nDots'; 'coherence'; 'scale'; 'driftDirection' },...
'Style','listbox',...
'Value',1,...
