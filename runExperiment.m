		...
		% ===================================================================
			...
			%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
				...
				while me.stopTask == false
					...
					% this retrieved value, but REMEMBER eyetracker will
					% save the properly sampled eye data; this is just a
					% backup sampled at the GPU FPS wrapped in the PTB
					% loop.
					...
					if me.doFlip
						...
						%----- LabJack: I/O needs to send strobe immediately after screen flip -----%
						%if me.sendStrobe && strcmp(me.strobe.device,'labjackt')
						%	sendStrobe(io); me.sendStrobe = false;
